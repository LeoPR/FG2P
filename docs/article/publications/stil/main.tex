...
($p_\text{correto}{=}0{,}40$, CE${=}0{,}916$): (a) near-miss
e$\to$\ipaE{} ($d{=}0{,}10$, $p(\hat{y}){=}0{,}45$) adiciona
DA${=}0{,}009$, total $L{=}0{,}925$; (b) catastr\'ofico a$\to$k
($d{=}0{,}90$, $p(\hat{y}){=}0{,}45$) adiciona DA${=}0{,}081$, total
$L{=}0{,}997$. A CE sozinha \'e id\^entica (0,916) em ambos os casos.
A DA fornece uma diferen\c{c}a de 9$\times$ na penalidade fonol\'ogica.
